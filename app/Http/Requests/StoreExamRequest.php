...
/**
 * @OA\RequestBody(
 *     request="StoreExamRequest",
 *     required=true,
 *     description="Dados para criar um exame",
 *     @OA\JsonContent(
 *         type="object",
 ...
 *         @OA\Property(property="icon", type="string", description="Ícone do exame"),
 *         @OA\Property(property="color", type="string", description="Cor do exame"),
 *     )
 * )
 */
